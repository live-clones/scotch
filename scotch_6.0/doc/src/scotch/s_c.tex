...
of \scotch, version~3 of the API will remain the default, and
version~5 of the \metis\ API must be activated by compiling
\scotch\ with flag \texttt{SCOTCH\_\lbt METIS\lbt V5} set. In further
branches, version~5 of the API may become the default, version~3
requiring the \texttt{SCOTCH\_\lbt METIS\lbt V3} flag to be set.
