...
sonar.coverage.exclusions=src/libscotch/dummysizes.c,src/libscotch/parser_ll.c,src/libscotch/parser_yy.c,src/libscotch/last_resort/parser_ll.c,src/libscotch/last_resort/parser_yy.c
