...
the Windows threading module, available since version
\textsc{7.0.5}. As the Scotch Consortium core engineer, he also
contributed to various improvements;
\item
...
\item
Xavier Muller contributed to the compilation chain;
\item
Tetsuya Mishima contributed to the Windows threading module, available
since version \textsc{7.0.5};
\item
Charles Pellegrini contributed to bug hunting and software quality in
branch \textsc{7.0};
\item
...
\item
Dimitri Walther provided insightful comments, feedback and patches for
the static mapping module.
\end{itemize}
