...
\caption{``\texttt{deco 0}'' target decomposition file for $\UB(2,3)$.
         The terminal domain numbers associated with every processor
         define a unique recursive bipartitioning of the target
         graph. In the file format, the list of terminal domains, with
         their label, weight, and terminal domain number, is followed
         by the triangular distance matrix between all terminal domain
         numbers.}
