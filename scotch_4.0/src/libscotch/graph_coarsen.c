...
#define GRAPHCOARSENEDGEVERTINIT    coargrafptr->verttax[coarvertnum] = coaredgenum
#define GRAPHCOARSENEDGEVERTEXIT    coargrafptr->verttax[coarvertnum] = coaredgenum
#define GRAPHCOARSENEDGEEDGEINIT    coargrafptr->edgetax[coaredgenum] = coarvertend
...
#undef GRAPHCOARSENEDGEVERTINIT
#undef GRAPHCOARSENEDGEVERTEXIT
#undef GRAPHCOARSENEDGEEDGEINIT
...
const Gnum                    coarvelomax)        /* Maximum vertex weight allowed     */
{
  ...
  if (finegrafptr->velotax != NULL) {
    ...
    for (finevertnum = finegrafptr->baseval;      /* Pre-selection loop for isoalted and lightest vertices */
